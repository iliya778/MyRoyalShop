...
namespace MyRoyalShop.Areas.Admin.Controllers
{
    ...
    public class ProductGroupsController : Controller
    {
        ...
        public ProductGroupsController(MyRoyalShopDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.ProductGroups != null ? 
                          ...
                          Problem("Entity set 'MyRoyalShopContext.ProductGroups'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'MyRoyalShopContext.ProductGroups'  is null.");
            }
            var productGroup = await _context.ProductGroups.FindAsync(id);
            if (productGroup != null)
            {
        ...
        {
          return (_context.ProductGroups?.Any(e => e.GroupId == id)).GetValueOrDefault();
        }
    }
}
