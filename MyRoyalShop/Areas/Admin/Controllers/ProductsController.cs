...
namespace MyEshop.Areas.Admin.Controllers
{
    ...
    public class ProductsController : Controller
    {
        ...
        public ProductsController(MyRoyalShopDbContext context)
        {
            _context = context;
        }
        ...
        {
            var myEshopDbContext = _context.Products.Include(p => p.productGroup);
            return View(await myEshopDbContext.ToListAsync());
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'MyEshopDbContext.Products'  is null.");
            }
            var product = await _context.Products.FindAsync(id);
            if (product != null)
            {
